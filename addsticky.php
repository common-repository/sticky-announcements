<?php
/**
 * StickyAnnounce WP Plugin
 * 
 * Easily add your StickyAnnounce to your WordPress blog!
 * 
 * @package StickyAnnounce
 *
 * @author oisin@addsticky.com
 * @version 1.0.0
 */
/*
Plugin Name: StickyAnnounce for WordPress
